...
#define LLWU_SW_GPIO_        BOARD_SW3_GPIO
#define LLWU_SW_PORT_        BOARD_SW3_PORT
#define LLWU_SW_GPIO_PIN_    BOARD_SW3_GPIO_PIN
#define LLWU_SW_IRQ_         BOARD_SW3_IRQ
#define LLWU_SW_IRQ_HANDLER_ BOARD_SW3_IRQ_HANDLER
#define LLWU_SW_NAME_        BOARD_SW3_NAME
